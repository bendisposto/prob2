...
public class TextualTrace {
	...
	private void displayWrappedLine(final ITraceDisplay display,
			final int maxLabelLength, final String line, final int type) {
	...
	private String filterStack(final String stackTrace,
			final String[] filterPatterns) {
