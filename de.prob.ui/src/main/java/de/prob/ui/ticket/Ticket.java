...
public class Ticket {
	...
	public Ticket(final String reporter, final String summary, final String cc,
			final String description, final Boolean sensitive) {
	...
	public void addAttachment(final Attachment a) {
