...
import de.bmotionstudio.core.editor.command.AddCommand;
import de.bmotionstudio.core.editor.command.BControlChangeLayoutCommand;
...
public class TableLayoutEditPolicy extends FlowLayoutEditPolicy {
	...
	protected Command createAddCommand(EditPart child, EditPart after) {
		...
		if ((childModel instanceof TableColumn && parentModel instanceof Table)
				|| (childModel instanceof TableCell
						&& parentModel instanceof TableColumn && childModel
	...
	protected Command createMoveChildCommand(EditPart child, EditPart after) {
		...
		if ((childModel instanceof TableColumn && parentModel instanceof Table)
				|| (childModel instanceof TableCell && parentModel instanceof TableColumn)) {
	...
	public void showLayoutTargetFeedback(Request request) {
		if (request instanceof CreateRequest) {
			...
			if (!(newObject instanceof TableColumn || newObject instanceof TableCell))
				return;
		}
