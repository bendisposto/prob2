...
import de.bmotionstudio.core.editor.BMSContextMenuProvider;
import de.bmotionstudio.core.editor.VisualizationViewPart;
import de.bmotionstudio.core.editor.part.BMSTreeEditPartFactory;
...
public class BMotionOutlinePage extends ContentOutlinePage {
	...
	private void initializeOutlineViewer() {
		getViewer().setContents(
				viewPart.getVisualizationView().getVisualization());
	}
