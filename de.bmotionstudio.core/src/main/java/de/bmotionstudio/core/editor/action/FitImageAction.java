...
import de.bmotionstudio.core.editor.command.FitImageCommand;
import de.bmotionstudio.core.model.control.BControl;

public class FitImageAction extends SelectionAction {

	public final static String ID = "de.bmotionstudio.core.action.fitImage";
	...
	public void run() {
		...
		// Map<BControl, org.eclipse.draw2d.geometry.Rectangle> newSizeMap = new
		// HashMap<BControl, org.eclipse.draw2d.geometry.Rectangle>();
		//
		// List<?> selectedObjects = getSelectedObjects();
		//
		// for (Object obj : selectedObjects) {
