 ...
 * 
 */
public abstract class PropertyChangeSupportObject implements Cloneable {
	...
	public PropertyChangeSupportObject clone() throws CloneNotSupportedException {
		PropertyChangeSupportObject clone = (PropertyChangeSupportObject) super.clone();
