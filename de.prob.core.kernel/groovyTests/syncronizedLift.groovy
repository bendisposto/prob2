...
h = h.add("inc",[])
assert h.toString().contains("0: [\$initialise_machine(4), inc()] Current Transition is: inc()\n1: [\$initialise_machine(4), inc()] Current Transition is: inc()\n")
h = h.add("inc",[])
assert h.toString().contains("0: [\$initialise_machine(4), inc(), inc()] Current Transition is: inc()\n1: [\$initialise_machine(4), inc(), inc()] Current Transition is: inc()\n")
h = h.add("dec",[],1)
...
assert h.toString().contains("0: [\$initialise_machine(4), inc(), inc()] Current Transition is: inc()\n1: [\$initialise_machine(4), inc(), inc(), dec()] Current Transition is: dec()\n")
h = h.add("inc", [], 1)
assert h.toString().contains("0: [\$initialise_machine(4), inc(), inc(), inc()] Current Transition is: inc()\n1: [\$initialise_machine(4), inc(), inc(), dec(), inc()] Current Transition is: inc()\n")