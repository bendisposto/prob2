	...
	public void testProcessResult1() throws ProBException {
		...
		when(map.get("PLOps")).thenReturn(
				new ListPrologTerm(new CompoundPrologTerm("bindings",
						new IntegerPrologTerm(24), new CompoundPrologTerm("foo"),
						new CompoundPrologTerm("bar"), new IntegerPrologTerm(27),
						new CompoundPrologTerm("sproing"), new CompoundPrologTerm("ding"))));

		GetEnabledOperationsCommand command = new GetEnabledOperationsCommand("state");
