...
public final class GetOperationByPredicateCommand implements ICommand {
	...
	// * satisfying <em></em> was found by ProB or an Operation object that can
	// be
	...
	//
	// GetOperationByPredicateCommand executeOperationCommand = new
	// GetOperationByPredicateCommand(
	...
	// * method is called by the Animator class, most likely it is not
	// interesting
	// * for other classes.
	// *
	// * @see
	// de.prob.core.command.IComposableCommand#writeCommand(de.prob.prolog.output.IPrologTermOutput)
	// */
	...
	//
	// /**
	// * This method is called to extract relevant information from ProB's
	// answer.
