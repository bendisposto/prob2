...
public class EvaluationGetValuesCommand implements ICommand {
	...
	// */
	// public static Collection<EvaluationStateElement>
	// getValuesForExpressionsUncached(
	...
	// result = Collections.emptyList();
	// } else {
	// final Map<EvaluationElement, EvaluationStateElement> cache =
	// getCache(state);
	// synchronized (cache) {
	...
	// Collection<EvaluationStateElement> computed =
	// getValuesForExpressionsUncached(
	// state, toCompute);
	...
	// if (result == null) {
	// Collection<EvaluationStateElement> values =
	// getValuesForExpressionsUncached(
	...
	// HistoryBasedCache<Map<EvaluationElement, EvaluationStateElement>> hcache
	// = (HistoryBasedCache<Map<EvaluationElement, EvaluationStateElement>>)
	// animator
	// .getData(CACHE_KEY);
	// if (hcache == null) {
	// History history = animator.getHistory();
	// hcache = new HistoryBasedCache<Map<EvaluationElement,
	...
	// Map<EvaluationElement, EvaluationResult> results = new
	// HashMap<EvaluationElement, EvaluationResult>();
