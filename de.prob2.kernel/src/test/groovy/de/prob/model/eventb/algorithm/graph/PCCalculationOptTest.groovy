...
class PCCalculationOptTest extends Specification {
	...
	def "optimized euclid"() {
		...
		pcInfo(graph) == [while0: 0, if0: 1, assign1: 2, assign2: 3, end_algorithm: 4]
	}
	...
	def "loop within loop"() {
		...
		then:
		if (DEBUG) print(graph)
		pcInfo(graph) == [while0: 0, if0: 1, while1: 2, assign2: 3, end_algorithm: 4]
	}
}
