...
assert trans.evaluate(true).getRep() == "4,{(5|->#4:{2,4,...,6,8})},6 <-- Crazy2(5,#4:{2,4,...,6,8})"
assert trans.evaluate(false).getRep() == "4,{(5|->{2,4,6,8})},6 <-- Crazy2(5,{2,4,6,8})"
assert trans.evaluate(true).getRep() == "4,{(5|->{2,4,6,8})},6 <-- Crazy2(5,{2,4,6,8})"
