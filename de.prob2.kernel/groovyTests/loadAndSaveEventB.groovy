...
api.eventb_save(s1, dir+File.separator+"Lift"+File.separator+"lift0.eventb")

final fileContents = new File(dir+File.separator+"Lift"+File.separator+"lift0.eventb").text.trim()
...
final s2 = api.eventb_load(dir+File.separator+"Lift"+File.separator+"lift0.eventb")
