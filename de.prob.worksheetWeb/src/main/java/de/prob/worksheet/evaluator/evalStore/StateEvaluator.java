...
public class StateEvaluator implements IWorksheetEvaluator{
	...
	/* (non-Javadoc)
	 * @see de.prob.worksheet.evaluator.IWorksheetEvaluator#setImport(de.prob.worksheet.api.state.StateAPI)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.prob.worksheet.evaluator.IWorksheetEvaluator#setInitialContext(java.lang.String[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.prob.worksheet.evaluator.IWorksheetEvaluator#evaluate(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.prob.worksheet.evaluator.IWorksheetEvaluator#evaluateObject(de.prob.worksheet.parser.SimpleConsoleParser.EvalObject)
	 */
	@Override
	public void evaluateObject(EvalObject evalObject){
		...
		this.api.setEvalStoreId((Long) this.contextHistory.last().getBinding("EvalStoreId"));
	...
	/* (non-Javadoc)
	 * @see de.prob.worksheet.evaluator.IWorksheetEvaluator#evaluateObjects(de.prob.worksheet.parser.SimpleConsoleParser.EvalObject[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.prob.worksheet.evaluator.IWorksheetEvaluator#evaluateScript(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.prob.worksheet.evaluator.IWorksheetEvaluator#parseScript(java.lang.String)
	 */
	@Override
	...
	public IBlock[] getOutputs(){
		...
		IBlock[] ret=this.outputBlocks.toArray(new IBlock[this.outputBlocks.size()]);
